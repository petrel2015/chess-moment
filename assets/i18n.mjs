...
export const UI = {
  zh: {
    ...
    settingsHint: "默认使用站点配置。你也可以填自己的智谱 API Key 和 Worker URL，Key 只存在本浏览器里。",
    settingsWorkerUrl: "Worker URL",
    settingsKey: "智谱 API Key（可选）",
    settingsKeyPlaceholder: "留空则用站点默认 Key",
    settingsOpenRouterKey: "OpenRouter API Key（可选）",
    settingsOpenRouterPlaceholder: "填入后直连 OpenRouter 免费模型，无需 Worker",
    settingsSave: "保存",
    settingsHelp: "没有 Key？看智谱开放平台（open.bigmodel.cn），GLM-4-Flash 模型免费。",
    toggleOther: "English",
  },
  ...
  en: {
    ...
    settingsHint: "Uses the site default. You can also provide your own Zhipu API key and Worker URL; the key stays in this browser.",
    settingsWorkerUrl: "Worker URL",
    settingsKey: "Zhipu API Key (optional)",
    settingsKeyPlaceholder: "Leave empty to use the site default key",
    settingsOpenRouterKey: "OpenRouter API Key (optional)",
    settingsOpenRouterPlaceholder: "Paste to call OpenRouter's free models directly, no worker needed",
    settingsSave: "Save",
    settingsHelp: "No key? See the Zhipu open platform (open.bigmodel.cn); the GLM-4-Flash model is free.",
    toggleOther: "中文",
  },
};
