...
export const UI = {
  zh: {
    ...
    aiDailyQuota: "今日 AI 额度已用完，请明天再试。",
    aiRateLimited: "AI 请求太频繁，请稍后再试。",
    aiUpstreamError: "AI 服务暂时不可用，请稍后重试。",
    askDefaultQuestion: "请讲讲这一步的思路。",
    aiSettingSaved: "已保存。",
    aiSettings: "AI 设置",
    settingsTitle: "AI 教练设置",
    settingsHint: "站点已内置 AI 网关，默认开箱即用；也可以选择平台并填入自己的 API Key 覆盖。Key 只保存在本浏览器。",
    settingsProvider: "AI 平台",
    providerDefault: "站点默认（棋刻 AI）",
  ...
  en: {
    ...
    aiUnavailable: "The current AI settings are unavailable. Please check the configuration.",
    aiDailyQuota: "Today's AI quota is used up. Please try again tomorrow.",
    aiRateLimited: "Too many AI requests. Please wait a moment and try again.",
    aiUpstreamError: "The AI service is temporarily unavailable. Please try again later.",
    askDefaultQuestion: "Please explain the thinking behind this move.",
    aiSettingSaved: "Saved.",
    aiSettings: "AI Settings",
    settingsTitle: "AI Coach Settings",
    settingsHint: "The built-in AI gateway works out of the box; you can also pick a provider and paste your own API key to override it. The key stays in this browser only.",
    settingsProvider: "AI provider",
    providerDefault: "Site default (Chess Moment AI)",
    ...
    // Donation (buy-me-coffee unified spec copy, verbatim)
    ...
    donateClose: "Close",
    donateQrError: "QR code failed to render, please retry.",
